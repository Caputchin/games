// Registers @caputchin/game-wall-smash with the iframe's Caputchin global. The
...
import { runWallSmash } from './game.js';

register((container, bridge, ctx) => runWallSmash({ container, bridge, ctx }));

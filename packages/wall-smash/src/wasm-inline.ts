// Decode the gzip+base64-inlined live Bevy wasm. It ships inlined (not fetched)
...
//
// Kept in its own module (no wasm-bindgen glue imports) so it is unit-testable:
// game.ts pulls in the generated bindgen glue, which only exists after a live build.

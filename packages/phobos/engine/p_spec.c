...
void P_InitPicAnims (void)
{
	...
	{
	    // Phobos: minimal IWADs may omit one end of an anim pair. Skip the
	    // anim unless BOTH start and end textures are present (we use no
	    // animated textures; this never alters a working anim).
